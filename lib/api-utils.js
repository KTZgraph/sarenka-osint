...
export async function getAllCWEs() {//zwraca listę obiektów
...
export async function getCWEById(cweId) { //zwraca obiekt
...
export async function getAllCVEs() {//zwraca obiekt
